...
export function handleCreateMatch(
    ...
    new_match.team_1_total_bets = BigInt.fromString(data.get('team_1_initial_pool')!.toString());
    new_match.team_2_total_bets = BigInt.fromString(data.get('team_2_initial_pool')!.toString());
